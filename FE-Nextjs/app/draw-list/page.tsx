  ...
  const handleLogout = () => {
    ...
    return (
      ...
      <div className="title-holder">
        <h1 className="draw-list-title">Your Draws</h1>
        {/* <button onClick={handleLogout} className="create-btn">
              <span className="create-btn-text">Logout</span>
        </button> */}
      ...
      <div className="container draw-list-content">
        <table className="table draw-table">
          <thead>
            <tr>
              <th>Symbol</th>
              <th>Shape</th>
